...
def main():
    ...
    left_1, middle_1, right_1 = st.columns([3,1,3])
    with middle_1:
    ...
    st.write("""The Kudela lab has created a digital library that comprises images and
             ...
             coastal waters of California, Oregon, and Washington. The online libary
             can be found
             [here](http://oceandatacenter.ucsc.edu/PhytoGallery/phytolist.html).
             This digital libary encompases the information found in *Tiny Drifters*,
    ...
    st.write("""A library of annotated plankton images for developing and evaluating
             ...
             The images found on this site were collectefd by an Imaging FlowCytobot, the
    ...
    left_2, middle_2, right_2 = st.columns([3,1,3])
    with middle_2:
